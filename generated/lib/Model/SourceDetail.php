...
/**
 * SourceDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SourceDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceDetail';
    ...
    */
     ...
     * Sets includes
     *
     * @param mixed|null $includes includes
     *
     * @return self
     */
    ...
    {
        if (is_null($includes)) {
            array_push($this->openAPINullablesSetToNull, 'includes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('includes', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets excludes
     *
     * @param mixed|null $excludes excludes
     *
     * @return self
     */
    ...
    {
        if (is_null($excludes)) {
            array_push($this->openAPINullablesSetToNull, 'excludes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('excludes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
