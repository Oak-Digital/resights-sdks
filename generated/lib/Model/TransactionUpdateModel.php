...
/**
 * TransactionUpdateModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionUpdateModel';
    ...
    */
    ...
    public function setCapRate($cap_rate)
    {
        ...
        if (!is_null($cap_rate) && ($cap_rate > 0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate when calling TransactionUpdateModel., must be smaller than or equal to 0.25.');
        }
        if (!is_null($cap_rate) && ($cap_rate < -0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate when calling TransactionUpdateModel., must be bigger than or equal to -0.25.');
        }
    ...
    public function setCapRateLower($cap_rate_lower)
    {
        ...
        if (!is_null($cap_rate_lower) && ($cap_rate_lower > 0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate_lower when calling TransactionUpdateModel., must be smaller than or equal to 0.25.');
        }
        if (!is_null($cap_rate_lower) && ($cap_rate_lower < -0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate_lower when calling TransactionUpdateModel., must be bigger than or equal to -0.25.');
        }
    ...
    public function setCapRateUpper($cap_rate_upper)
    {
        ...
        if (!is_null($cap_rate_upper) && ($cap_rate_upper > 0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate_upper when calling TransactionUpdateModel., must be smaller than or equal to 0.25.');
        }
        if (!is_null($cap_rate_upper) && ($cap_rate_upper < -0.25)) {
            throw new \InvalidArgumentException('invalid value for $cap_rate_upper when calling TransactionUpdateModel., must be bigger than or equal to -0.25.');
        }
    ...
    public function setAssetStages($asset_stages)
    {
        ...
        if (!is_null($asset_stages) && (count($asset_stages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asset_stages when calling TransactionUpdateModel., number of items must be greater than or equal to 1.');
        }
    ...
    public function setAssetTypes($asset_types)
    {
        ...
        if (!is_null($asset_types) && (count($asset_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asset_types when calling TransactionUpdateModel., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBfeNumbers($bfe_numbers)
    {
        ...
        if (!is_null($bfe_numbers) && (count($bfe_numbers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bfe_numbers when calling TransactionUpdateModel., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBuyers($buyers)
    {
        ...
        if (!is_null($buyers) && (count($buyers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $buyers when calling TransactionUpdateModel., number of items must be greater than or equal to 1.');
        }
    ...
    public function setSellers($sellers)
    {
        ...
        if (!is_null($sellers) && (count($sellers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sellers when calling TransactionUpdateModel., number of items must be greater than or equal to 1.');
        }
