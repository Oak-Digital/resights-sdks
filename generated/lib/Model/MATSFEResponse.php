...
/**
 * MATSFEResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MATSFEResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MATSFEResponse';
    ...
    protected static $openAPITypes = [
        ...
        'worker_house' => 'mixed',
        'is_common_lot' => 'mixed',
        'mother_property_divided_into_condominiums' => 'mixed',
        'agriculture_listing' => 'mixed',
        'separated_road' => 'mixed',
        'lands' => 'mixed'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'worker_house' => null,
        'is_common_lot' => null,
        'mother_property_divided_into_condominiums' => null,
        'agriculture_listing' => null,
        'separated_road' => null,
        'lands' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'worker_house' => true,
		'is_common_lot' => true,
		'mother_property_divided_into_condominiums' => true,
		'agriculture_listing' => true,
		'separated_road' => true,
		'lands' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'mother_property_divided_into_condominiums' => 'mother_property_divided_into_condominiums',
        'agriculture_listing' => 'agriculture_listing',
        'separated_road' => 'separated_road',
        'lands' => 'lands'
    ];
    ...
    protected static $setters = [
        ...
        'worker_house' => 'setWorkerHouse',
        'is_common_lot' => 'setIsCommonLot',
        'mother_property_divided_into_condominiums' => 'setMotherPropertyDividedIntoCondominiums',
        'agriculture_listing' => 'setAgricultureListing',
        'separated_road' => 'setSeparatedRoad',
        'lands' => 'setLands'
    ];
    ...
    protected static $getters = [
        ...
        'worker_house' => 'getWorkerHouse',
        'is_common_lot' => 'getIsCommonLot',
        'mother_property_divided_into_condominiums' => 'getMotherPropertyDividedIntoCondominiums',
        'agriculture_listing' => 'getAgricultureListing',
        'separated_road' => 'getSeparatedRoad',
        'lands' => 'getLands'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('worker_house', $data ?? [], null);
        $this->setIfExists('is_common_lot', $data ?? [], null);
        $this->setIfExists('mother_property_divided_into_condominiums', $data ?? [], null);
        $this->setIfExists('agriculture_listing', $data ?? [], null);
        $this->setIfExists('separated_road', $data ?? [], null);
        $this->setIfExists('lands', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['worker_house'] === null) {
            $invalidProperties[] = "'worker_house' can't be null";
        }
        if ($this->container['is_common_lot'] === null) {
            $invalidProperties[] = "'is_common_lot' can't be null";
        }
        if ($this->container['mother_property_divided_into_condominiums'] === null) {
            $invalidProperties[] = "'mother_property_divided_into_condominiums' can't be null";
        }
        if ($this->container['separated_road'] === null) {
            $invalidProperties[] = "'separated_road' can't be null";
        }
        if ($this->container['lands'] === null) {
            $invalidProperties[] = "'lands' can't be null";
        }
     ...
     * @return mixed
     */
    public function getWorkerHouse()
    {
        return $this->container['worker_house'];
    }

    /**
     * Sets worker_house
     *
     * @param mixed $worker_house Angiver om den samlede faste ejendom er en arbejderbolig.
     *
     * @return self
     */
    public function setWorkerHouse($worker_house)
    {
        if (is_null($worker_house)) {
            array_push($this->openAPINullablesSetToNull, 'worker_house');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('worker_house', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['worker_house'] = $worker_house;
     ...
     * Sets is_common_lot
     *
     * @param mixed $is_common_lot Angiver, at typen af samlet fast ejendom er fælleslod.
     *
     * @return self
     */
    ...
    /**
     * Gets mother_property_divided_into_condominiums
     *
     * @return mixed
     */
    public function getMotherPropertyDividedIntoCondominiums()
    {
        return $this->container['mother_property_divided_into_condominiums'];
    }

    /**
     * Sets mother_property_divided_into_condominiums
     *
     * @param mixed $mother_property_divided_into_condominiums Angiver, om den pågældende samlede faste ejendom er registreret som hovedejendom og opdelt i ejerlejligheder.
     *
     * @return self
     */
    public function setMotherPropertyDividedIntoCondominiums($mother_property_divided_into_condominiums)
    {
        if (is_null($mother_property_divided_into_condominiums)) {
            array_push($this->openAPINullablesSetToNull, 'mother_property_divided_into_condominiums');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('mother_property_divided_into_condominiums', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['mother_property_divided_into_condominiums'] = $mother_property_divided_into_condominiums;

        return $this;
    }

    /**
     * Gets agriculture_listing
     *
     * @return mixed|null
     */
    public function getAgricultureListing()
    {
        return $this->container['agriculture_listing'];
    }

    /**
     * Sets agriculture_listing
     *
     * @param mixed|null $agriculture_listing Angiver hvorvidt ejendommen er noteret som landbrugsejendom og derfor har landbrugspligt.
     *
     * @return self
     */
    public function setAgricultureListing($agriculture_listing)
    {
        if (is_null($agriculture_listing)) {
            array_push($this->openAPINullablesSetToNull, 'agriculture_listing');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('agriculture_listing', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['agriculture_listing'] = $agriculture_listing;
     ...
     * @return mixed
     */
    public function getSeparatedRoad()
    {
        return $this->container['separated_road'];
    }

    /**
     * Sets separated_road
     *
     * @param mixed $separated_road Angiver, om der er tale om en udskilt, offentlig vej med selvstændigt  matrikelnummer.
     *
     * @return self
     */
    public function setSeparatedRoad($separated_road)
    {
        if (is_null($separated_road)) {
            array_push($this->openAPINullablesSetToNull, 'separated_road');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('separated_road', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['separated_road'] = $separated_road;
    ...
    {
        return $this->container['lands'];
    }

    /**
     * Sets lands
     *
     * @param mixed $lands lands
     *
     * @return self
     */
    ...
    {
        if (is_null($lands)) {
            array_push($this->openAPINullablesSetToNull, 'lands');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lands', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lands'] = $lands;
