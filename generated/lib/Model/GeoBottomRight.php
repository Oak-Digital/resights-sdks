...
/**
 * GeoBottomRight Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeoBottomRight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeoBottomRight';
    ...
    */
    ...
    {
        if (is_null($max_lon)) {
            array_push($this->openAPINullablesSetToNull, 'max_lon');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_lon', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($min_lat)) {
            array_push($this->openAPINullablesSetToNull, 'min_lat');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('min_lat', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
