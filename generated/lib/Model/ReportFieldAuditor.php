...
/**
 * ReportFieldAuditor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReportFieldAuditor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportFieldAuditor';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mne_number', $data ?? [], null);
    ...
    */
     ...
     * Sets enterprise
     *
     * @param mixed|null $enterprise enterprise
     *
     * @return self
     */
    public function setEnterprise($enterprise)
    {
        if (is_null($enterprise)) {
            array_push($this->openAPINullablesSetToNull, 'enterprise');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('enterprise', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return mixed|null
     */
    public function getMneNumber()
    {
        return $this->container['mne_number'];
    }

    /**
     * Sets mne_number
     *
     * @param mixed|null $mne_number mne_number
     *
     * @return self
     */
    public function setMneNumber($mne_number)
    {
        if (is_null($mne_number)) {
            array_push($this->openAPINullablesSetToNull, 'mne_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('mne_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['mne_number'] = $mne_number;
