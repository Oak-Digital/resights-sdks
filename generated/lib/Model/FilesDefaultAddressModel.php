...
/**
 * FilesDefaultAddressModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FilesDefaultAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilesDefaultAddressModel';
    ...
    {
        $this->setIfExists('overlay', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($overlay)) {
            array_push($this->openAPINullablesSetToNull, 'overlay');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('overlay', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets att_name
     *
     * @param mixed|null $att_name att_name
     *
     * @return self
     */
    ...
    {
        if (is_null($att_name)) {
            array_push($this->openAPINullablesSetToNull, 'att_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('att_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
