...
/**
 * GeoBBoxPairs Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeoBBoxPairs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeoBBoxPairs';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['top_left'] === null) {
            $invalidProperties[] = "'top_left' can't be null";
        }
        if ((count($this->container['top_left']) > 2)) {
        ...
        if ($this->container['bottom_right'] === null) {
            $invalidProperties[] = "'bottom_right' can't be null";
        }
        if ((count($this->container['bottom_right']) > 2)) {
    ...
    public function setTopLeft($top_left)
    {
        ...
        if (!is_null($top_left) && (count($top_left) > 2)) {
            throw new \InvalidArgumentException('invalid value for $top_left when calling GeoBBoxPairs., number of items must be less than or equal to 2.');
        }
        if (!is_null($top_left) && (count($top_left) < 2)) {
            throw new \InvalidArgumentException('invalid length for $top_left when calling GeoBBoxPairs., number of items must be greater than or equal to 2.');
        }
     ...
     * Sets bottom_right
     *
     * @param mixed $bottom_right bottom_right
     *
     * @return self
     */
    public function setBottomRight($bottom_right)
    {
        ...
        if (!is_null($bottom_right) && (count($bottom_right) > 2)) {
            throw new \InvalidArgumentException('invalid value for $bottom_right when calling GeoBBoxPairs., number of items must be less than or equal to 2.');
        }
        if (!is_null($bottom_right) && (count($bottom_right) < 2)) {
            throw new \InvalidArgumentException('invalid length for $bottom_right when calling GeoBBoxPairs., number of items must be greater than or equal to 2.');
        }
