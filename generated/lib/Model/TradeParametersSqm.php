...
/**
 * TradeParametersSqm Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TradeParametersSqm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradeParametersSqm';
    ...
    */
     ...
     * Sets sqm_price
     *
     * @param mixed|null $sqm_price Short hand field for first available SQM-price. Generally `floor_area_br18` is preferred. However, for agricultural properties, `land_area` is used, while for condominiums `unit_area` is used.
     *
     * @return self
     */
    public function setSqmPrice($sqm_price)
    {
        if (is_null($sqm_price)) {
            array_push($this->openAPINullablesSetToNull, 'sqm_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sqm_price', $nullablesSetToNull);
            if ($index !== FALSE) {
