...
/**
 * IndicatorResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IndicatorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IndicatorResponse';
    ...
    protected static $openAPITypes = [
        'theme' => '\OpenAPI\Client\Model\IndicatorThemeEnum',
        'count' => 'mixed',
        'active' => 'mixed',
        'indicators' => 'mixed'
    ];
    ...
    */
     ...
     * Gets theme
     *
     * @return \OpenAPI\Client\Model\IndicatorThemeEnum
     */
     ...
     * Sets theme
     *
     * @param \OpenAPI\Client\Model\IndicatorThemeEnum $theme theme
     *
     * @return self
     */
     ...
     * Sets indicators
     *
     * @param mixed $indicators indicators
     *
     * @return self
     */
    public function setIndicators($indicators)
    {
        if (is_null($indicators)) {
            array_push($this->openAPINullablesSetToNull, 'indicators');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('indicators', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
