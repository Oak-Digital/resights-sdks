...
/**
 * FilesMetaResponseModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FilesMetaResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilesMetaResponseModel';
    ...
    */
     ...
     * Sets subfolder
     *
     * @param mixed|null $subfolder subfolder
     *
     * @return self
     */
    public function setSubfolder($subfolder)
    {
        if (is_null($subfolder)) {
            array_push($this->openAPINullablesSetToNull, 'subfolder');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('subfolder', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
