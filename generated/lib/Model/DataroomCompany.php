...
/**
 * DataroomCompany Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DataroomCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataroomCompany';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('org_nr', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['org_nr'] === null) {
            $invalidProperties[] = "'org_nr' can't be null";
        }
    ...
    {
        return $this->container['org_nr'];
    }

    /**
     * Sets org_nr
     *
     * @param mixed $org_nr org_nr
     *
     * @return self
     */
    public function setOrgNr($org_nr)
    {
        if (is_null($org_nr)) {
            array_push($this->openAPINullablesSetToNull, 'org_nr');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('org_nr', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['org_nr'] = $org_nr;
     ...
     * Sets country_iso
     *
     * @param mixed $country_iso country_iso
     *
     * @return self
     */
