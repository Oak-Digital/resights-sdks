...
/**
 * DomusProAssociationDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomusProAssociationDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomusProAssociationDetailResponse';
    ...
    */
     ...
     * Sets assessments
     *
     * @param mixed|null $assessments assessments
     *
     * @return self
     */
    public function setAssessments($assessments)
    {
        if (is_null($assessments)) {
            array_push($this->openAPINullablesSetToNull, 'assessments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('assessments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
