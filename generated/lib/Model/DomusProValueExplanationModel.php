...
/**
 * DomusProValueExplanationModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomusProValueExplanationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomusProValueExplanationModel';
    ...
    */
     ...
     * Sets yellow
     *
     * @param mixed|null $yellow yellow
     *
     * @return self
     */
    ...
    {
        if (is_null($yellow)) {
            array_push($this->openAPINullablesSetToNull, 'yellow');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('yellow', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
