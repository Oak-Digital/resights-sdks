...
/**
 * DomusProRatingFormatModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomusProRatingFormatModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomusProRatingFormatModel';
    ...
    */
     ...
     * Sets decimals
     *
     * @param mixed|null $decimals decimals
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $decimal_separator decimal_separator
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $thousands_separator thousands_separator
     *
     * @return self
     */
    public function setThousandsSeparator($thousands_separator)
    {
        if (is_null($thousands_separator)) {
            array_push($this->openAPINullablesSetToNull, 'thousands_separator');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('thousands_separator', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
