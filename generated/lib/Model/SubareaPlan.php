 ...
 */
class SubareaPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubareaPlan';
    ...
    protected static $attributeMap = [
        ...
        'building_field_type' => 'building_field_type',
    ...
    protected static $setters = [
        ...
        'building_field_type' => 'setBuildingFieldType',
    ...
    protected static $getters = [
        ...
        'building_field_type' => 'getBuildingFieldType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('local_plan_id', $data ?? [], null);
        ...
        $this->setIfExists('building_field_type', $data ?? [], null);
    ...
    */
     ...
     * Sets plan_id
     *
     * @param mixed $plan_id Planid for planen. Genereres af systemet.
     *
     * @return self
     */
     ...
     * @return mixed|null
     */
    public function getLocalPlanId()
    {
        return $this->container['local_plan_id'];
    }

    /**
     * Sets local_plan_id
     *
     * @param mixed|null $local_plan_id local_plan_id
     *
     * @return self
     */
    public function setLocalPlanId($local_plan_id)
    {
        if (is_null($local_plan_id)) {
            array_push($this->openAPINullablesSetToNull, 'local_plan_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('local_plan_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['local_plan_id'] = $local_plan_id;
     ...
     * Sets part_number
     *
     * @param mixed|null $part_number Navn på delområde.
     *
     * @return self
     */
     ...
     * Sets plan_name
     *
     * @param mixed|null $plan_name Delområdets navn.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $conservation_description Kort beskrivelse af eventuelle bevaringsbestemmelser i planen.
     *
     * @return self
     */
    ...
    /**
     * Gets building_field_type
     *
     * @return mixed|null
     */
    public function getBuildingFieldType()
    {
        return $this->container['building_field_type'];
    }

    /**
     * Sets building_field_type
     *
     * @param mixed|null $building_field_type building_field_type
     *
     * @return self
     */
    public function setBuildingFieldType($building_field_type)
    {
        if (is_null($building_field_type)) {
            array_push($this->openAPINullablesSetToNull, 'building_field_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('building_field_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['building_field_type'] = $building_field_type;
