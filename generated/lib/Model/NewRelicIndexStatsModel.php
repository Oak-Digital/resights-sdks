...
/**
 * NewRelicIndexStatsModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewRelicIndexStatsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewRelicIndexStatsModel';
    ...
    protected static $attributeMap = [
        ...
        'count_unique_companies' => 'count_unique_companies',
    ...
    protected static $setters = [
        ...
        'count_unique_companies' => 'setCountUniqueCompanies',
    ...
    protected static $getters = [
        ...
        'count_unique_companies' => 'getCountUniqueCompanies',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('count_unique_companies', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['count_unique_companies'] === null) {
            $invalidProperties[] = "'count_unique_companies' can't be null";
        }
    ...
    /**
     * Gets count_unique_companies
     *
     * @return mixed
     */
    public function getCountUniqueCompanies()
    {
        return $this->container['count_unique_companies'];
    }

    /**
     * Sets count_unique_companies
     *
     * @param mixed $count_unique_companies count_unique_companies
     *
     * @return self
     */
    public function setCountUniqueCompanies($count_unique_companies)
    {
        if (is_null($count_unique_companies)) {
            array_push($this->openAPINullablesSetToNull, 'count_unique_companies');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('count_unique_companies', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['count_unique_companies'] = $count_unique_companies;
