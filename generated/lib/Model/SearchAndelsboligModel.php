...
/**
 * SearchAndelsboligModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchAndelsboligModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchAndelsboligModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('kommunenavn', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param mixed|null $id Unik identifikator.
     *
     * @return self
     */
    ...
    {
        return $this->container['kommunenavn'];
    }

    /**
     * Sets kommunenavn
     *
     * @param mixed|null $kommunenavn The name of a municipality.
     *
     * @return self
     */
    public function setKommunenavn($kommunenavn)
    {
        if (is_null($kommunenavn)) {
            array_push($this->openAPINullablesSetToNull, 'kommunenavn');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('kommunenavn', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['kommunenavn'] = $kommunenavn;
