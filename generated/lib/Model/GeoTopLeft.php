 ...
 */
class GeoTopLeft implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeoTopLeft';
    ...
    */
    ...
    {
        if (is_null($min_lon)) {
            array_push($this->openAPINullablesSetToNull, 'min_lon');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('min_lon', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($max_lat)) {
            array_push($this->openAPINullablesSetToNull, 'max_lat');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_lat', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
