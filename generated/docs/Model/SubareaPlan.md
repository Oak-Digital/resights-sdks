...
**id** | **mixed** |  |
**oid** | **mixed** |  |
**plan_id** | **mixed** | Planid for planen. Genereres af systemet. |
**local_plan_id** | **mixed** |  | [optional]
**part_number** | **mixed** | Navn på delområde. | [optional]
...
**plan_name** | **mixed** | Delområdets navn. | [optional]
...
**conservation_description** | **mixed** | Kort beskrivelse af eventuelle bevaringsbestemmelser i planen. | [optional]
